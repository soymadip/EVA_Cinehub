...
@Client.on_message(filters.command('batchs') & filters.user(ADMINS))
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/TeamEva https://t.me/Team</code>.")
    ...
    post = await bot.send_document(LOG_CHANNEL, f"batchmode_{message.from_user.id}.json", file_name="Batch.json", disable_notification=True)
