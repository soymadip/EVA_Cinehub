...
async def gen_link_batch(bot, message):
    ...
    post = await bot.send_document(LOG_CHANNEL,disable_notification=True f"batchmode_{message.from_user.id}.json", file_name="Batch.json", caption="⚠️Generated for filestore.")
